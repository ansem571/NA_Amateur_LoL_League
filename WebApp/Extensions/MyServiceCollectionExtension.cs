...
namespace Web.Extensions
{
    public static class MyServiceCollectionExtension
    {
        ...
        {
            services.AddDbConnections(config);
            services.AddStores();
            services.AddMappers();
        ...
        public static IServiceCollection AddStores(this IServiceCollection services)
        {
            ...
            //services.TryAddSingleton<IUserEmailStore<UserEntity>, UserStore>();
            //services.TryAddSingleton<IUserPhoneNumberStore<UserEntity>, UserStore>();
            //services.TryAddSingleton<IUserTwoFactorStore<UserEntity>, UserStore>();
            //services.TryAddSingleton<IUserRoleStore<UserEntity>, UserStore>();
