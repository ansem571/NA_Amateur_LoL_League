...
namespace Domain.Services.Implementations
{
    ...
    public class GameInfoService : IGameInfoService
    {
        ...
        private void SetupGameInfos(TeamRosterEntity homeTeam, TeamRosterEntity awayTeam, Dictionary<int, List<KeyValuePair<MatchDetailKey, MatchDetailEntity>>> groupedMatchDetails, List<MatchMvpEntity> mvpStats, Dictionary<Guid?, ChampionStatsEntity> championsPlayed, Dictionary<Guid, LookupEntity> roles, Dictionary<Guid, LookupEntity> champions, Dictionary<Guid, SummonerInfoEntity> registeredPlayers)
        {
            var gameNum = 0;
