...
namespace Domain.Mappers.Implementations
{
    ...
    {
        public Guid? MapFromEnum(PhoneCarrier carrier)
        {
            switch (carrier)
            {
                case PhoneCarrier.ATT:
